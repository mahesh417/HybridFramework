...
public class Keywords {
	...
	public static Xls_Reader xls = new Xls_Reader(System.getProperty("user.dir")+"\\src\\com\\w2a\\hybrid\\xls\\Test Suite1.xlsx");
	...
	private Keywords(){
		...
		try {
			...
			FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"\\src\\com\\w2a\\hybrid\\config\\config.properties");
			CONFIG.load(fs);
			// OR
			OR = new Properties();
			fs = new FileInputStream(System.getProperty("user.dir")+"\\src\\com\\w2a\\hybrid\\config\\OR.properties");
			OR.load(fs);
